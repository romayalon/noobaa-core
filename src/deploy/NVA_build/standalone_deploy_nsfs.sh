...
function main() {
    ...
    execute "node src/cmd/noobaa-cli account add --name cephalt --new_buckets_path ${FS_ROOT_1} --uid 1000 --gid 1000" nsfs_cephalt.log
    execute "node src/cmd/noobaa-cli account add --name cephtenant --new_buckets_path ${FS_ROOT_2} --uid 2000 --gid 2000" nsfs_cephtenant.log
