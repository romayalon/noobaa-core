...
// SYSTEM_STORE_SOURCE determines the preferred source for loading system_store data.
// "DB" = load from the database (backend is chosen by DB_TYPE env, default postgres).
// "CORE" = load from the system_server in noobaa-core (cluster master in-memory copy).
// Set via env: SYSTEM_STORE_SOURCE=DB or SYSTEM_STORE_SOURCE=CORE
...
config.DEEP_ARCHIVE_RESTORE_WORKER_ENABLED = true;
config.DEEP_ARCHIVE_RESTORE_BATCH_SIZE = 20;
config.DEEP_ARCHIVE_RESTORE_EMPTY_DELAY = 30000;
config.DEEP_ARCHIVE_RESTORE_BATCH_DELAY = 1000;
config.DEEP_ARCHIVE_RESTORE_ERROR_DELAY = 5000;
config.DEEP_ARCHIVE_RESTORE_BUSY_DELAY = 15000;

config.DEEP_ARCHIVE_RESTORE_EXPIRY_WORKER_ENABLED = true;
config.DEEP_ARCHIVE_RESTORE_EXPIRY_BATCH_SIZE = 100;
config.DEEP_ARCHIVE_RESTORE_EXPIRY_EMPTY_DELAY = 30000;
config.DEEP_ARCHIVE_RESTORE_EXPIRY_BATCH_DELAY = 1000;
config.DEEP_ARCHIVE_RESTORE_EXPIRY_ERROR_DELAY = 5000;
